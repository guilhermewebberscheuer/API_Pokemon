...
import com.api.API_Pokedex.service.PokedexService;
...
public class PokedexController {
    ...
    public String adicionarPokemon(@RequestBody PokedexModel pokemon) {
        ...
        return pokedexService.adicionarPokemon(pokemon);
    }

    @GetMapping
    public List<PokedexModel> listarPokemon() {
        return pokedexService.listarPokemons();
    }

    @GetMapping("/{id}")
    public PokedexModel buscarPokemonId(
            @PathVariable Long id) {

        return pokedexService.buscarPokemonPorId(id);
    }

    @PutMapping("/{id}")
    public String atualizarPokemon(
            @PathVariable Long id,
            @RequestBody PokedexModel pokemon) {

        return pokedexService.atualizarPokemon(id, pokemon);
    }
    ...
    public String deletarPokemonId(
        ...
        return pokedexService.deletarPokemon(id);
    }
